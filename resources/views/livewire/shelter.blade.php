<x-scrollable-container>
    <div x-ref="scrollContainer" x-on:scroll="scrollPos = $event.target.scrollLeft"
        class="flex space-x-4 overflow-x-auto scroll-smooth">
        {{-- <h2 class="font-bold text-2xl">Shelters</h2> --}}
        @foreach ($shelters as $shelter)
        <section class="flex flex-col items-center justify-center drop-shadow-md border p-5 m-2 rounded-xl hover:bg-btnprimary"
