<div class="absolute right-0 z-50" x-data="{ open: false, sexOptions: false, ageOptions: false, colorOptions: false }">
    <button x-on:click="open = !open" class="primary-button-default">
